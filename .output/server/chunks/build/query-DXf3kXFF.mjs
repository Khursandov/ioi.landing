...
import { e as useNuxtApp, f as asyncDataDefaults, g as createError, c as useRuntimeConfig, l as withLeadingSlash, j as joinURL, b as withoutTrailingSlash, i as withBase, k as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-41IrNCvO.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DXf3kXFF.mjs.map
