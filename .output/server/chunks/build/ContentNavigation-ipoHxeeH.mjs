...
import { D as hash } from '../runtime.mjs';
import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-DXf3kXFF.mjs';
import { u as useContentPreview } from './preview-ClUwsr5N.mjs';
import { d as useState, c as useRuntimeConfig, _ as __nuxt_component_0$1 } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-41IrNCvO.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-ipoHxeeH.mjs.map
