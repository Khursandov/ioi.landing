import { hasInjectionContext, inject, version, unref, h, toRef, isRef, ref, defineAsyncComponent, defineComponent, getCurrentInstance, computed, Suspense, nextTick, mergeProps, Transition, provide, useSSRContext, withCtx, createVNode, createTextVNode, resolveComponent, watch, Fragment, createApp, effectScope, shallowReactive, reactive, getCurrentScope, shallowRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, Text, isShallow, isReactive, toRaw, markRaw } from 'vue';
import { $ as $fetch, l as createError$1, F as klona, G as parse$1, H as getRequestHeader, r as destr, I as isEqual$1, J as setCookie, K as getCookie, L as deleteCookie, M as createHooks, N as sanitizeStatusCode, O as toRouteMatcher, P as createRouter$1, p as defu, Q as getRequestHeaders } from '../runtime.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrRenderClass, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-8vTo2wsS.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-nTlTNQB4.mjs')
  },
  {
    name: "ranking",
    path: "/ranking",
    component: () => import('./ranking-CDL3FjYM.mjs')
  },
  {
    name: "rules",
    path: "/rules",
    component: () => import('./rules-Bl_GI17v.mjs')
  },
  {
    name: "schedule",
    path: "/schedule",
    component: () => import('./schedule-CgP2-XgD.mjs')
  },
  {
    name: "tasks",
    path: "/tasks",
    component: () => import('./tasks-DW_RkqZl.mjs')
  },
  {
    name: "team",
    path: "/team",
    component: () => import('./team-DOsYd0RB.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-CIqKQtCk.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-COyMAFro.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-ipoHxeeH.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-8gUy6cNs.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-CUJAjSYy.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-wkX00r6t.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-rzW9W43q.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-D718frtx.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-C3_TA0xG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-qshbtglT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-sH9H0bvm.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-CVeUKhsg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BEBW5bPv.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-znUskw8q.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-qBi6YGis.mjs')
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Toaster), { position: "top-center" }, null, _parent));
      _push(`<noscript><div><img src="https://mc.yandex.ru/watch/98672866" style="${ssrRenderStyle({ "position": "absolute", "left": "-9999px" })}" alt=""></div></noscript></div>`);
    };
  }
});
...
const _imports_0 = publicAssetsURL("/images/header-logo.png");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "bg-white px-6 py-4" }, _attrs))}><div class="container mx-auto flex items-center justify-between"><div class="flex items-center space-x-3">`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="APIO Logo" class="h-auto max-w-[240px]"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
                alt: "APIO Logo",
                class: "h-auto max-w-[240px]"
              })
            ];
          }
        }),
      ...
      _push(`</div><nav class="hidden space-x-6 text-base font-medium text-black md:flex">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        "active-class": "border-b-2 border-blue-600 pb-1",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` APIO 2025 Team `);
          } else {
            return [
              createTextVNode(" APIO 2025 Team ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</nav><a href="#" class="rounded-lg bg-gradient-to-r from-[#345CFE] to-[#4A98FE] px-5 py-2 font-medium text-white transition hover:brightness-110"> Register </a></div></header>`);
    };
  }
});
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      if (unref(getError).statusCode !== 500) {
        _push(ssrRenderComponent(_component_LayoutHeader, null, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="${ssrRenderClass([{ "!mt-0 h-screen": unref(getError).statusCode === 500 }, "container mt-6 flex flex-col items-center justify-center rounded-lg bg-white px-6 py-24 md:mt-10 md:px-8"])}"><img${ssrRenderAttr("src", unref(getError).image)} class="w-full max-w-[320px] object-contain md:max-w-[450px]" alt="error"><div class="flex flex-col items-center justify-center gap-10"><h1 class="leading-170 mt-7 text-center text-base font-semibold text-slate-900 md:text-3xl">${ssrInterpolate(unref(getError).title)}</h1></div></div></div>`);
    };
  }
});
...
export { useLocalePath as A, useDevice as B, _sfc_main$2 as C, LayoutMetaSymbol as L, PageRouteSymbol as P, __nuxt_component_0$1 as _, useRoute as a, withoutTrailingSlash as b, useRuntimeConfig as c, useState as d, entry$1 as default, useNuxtApp as e, asyncDataDefaults as f, createError as g, hasProtocol as h, withBase as i, joinURL as j, useRequestEvent as k, withLeadingSlash as l, useCookie as m, injectHead as n, encodeParam as o, parseURL as p, encodePath as q, resolveUnrefHeadInput as r, generateRouteKey$1 as s, appPageTransition as t, useI18n as u, appKeepalive as v, withTrailingSlash as w, _wrapIf as x, wrapInKeepAlive as y, toArray as z };
