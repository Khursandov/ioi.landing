  ...
  <section class="bg-white px-6 py-12 md:py-16">
    ...
    >
      ...
      <div class="text-center md:w-2/3 md:text-left">
        ...
        <p class="text-base text-[#223553] md:text-lg">
          The IOI 2026 is organised by the Ministry of Digital Technologies of
          Republic of Uzbekistan and Digital Education Development Center.
        </p>
      </div>
    </div>
  </section>
